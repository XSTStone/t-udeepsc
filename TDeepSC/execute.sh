...
CUDA_VISIBLE_DEVICES=1 python3  tdeepsc_main.py --model  TDeepSC_textr_model --output_dir ckpt_record --batch_size 30 --input_size 32 --lr  3e-5 --epochs 20 --opt_betas 0.95 0.99  --save_freq 2 --ta_perform textr --eval